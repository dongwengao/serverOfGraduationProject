...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content">
            等待通知
            <audio id="music" src="${pageContext.request.contextPath}/img/music.mp3" loop>
            </audio>
            <p id="alterp" style="width: 100%;height: 45px;display: block;line-height: 45px;text-align: center;">
            </p>
        </section>
    </div>
    <!-- /.content-wrapper -->
...
<script src="${pageContext.request.contextPath}/static/sockjs.min.js"></script>
<script type="text/javascript">

    var websocket = null;
    if ('WebSocket' in window) {
        websocket = new WebSocket("ws://www.dongwengao.club/gp/websocket/socketServer");
    }
    else if ('MozWebSocket' in window) {
        websocket = new MozWebSocket("ws://www.dongwengao.club/gp/websocket/socketServer");
    }
    else {
        websocket = new SockJS("http://www.dongwengao.club/gp/sockjs/socketServer");
    }
    ...
    function onMessage(evt) {
        ...
        music.play();
        var p=document.getElementById("alterp");
