...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/fileinput.css">
    <!-- Font Awesome -->
...
<script src="${pageContext.request.contextPath}/static/fileinput.js"></script>
<script>
    $(document).ready(function () {
        $("#kv-explorer").fileinput({
            'theme': 'explorer-fa',
            'uploadUrl': '${pageContext.request.contextPath}/manager1/doexcel',
