...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/bootstrap-datetimepicker.min.css" rel="stylesheet">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/merchandise/getallmerchandise?id=${employee.id}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>查看货物信息</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/merchandise/getneeddispatche?id=${employee.id}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>待调度货物信息</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/truck/truckall?id=${employee.id}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>查看卡车信息</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/truck/usetruck?id=${employee.id}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>可调度卡车信息</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/driver/drivers?id=${employee.id}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>查看司机信息</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/driver/driversuse?id=${employee.id}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>可调度司机信息</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/dispatch/makedispatcher?id=${employee.id}" class="nav-link">
                            <i class="fa fa-circle-o nav-icon"></i>
                            <p>生成调度单</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/dispatch/alldispatch?id=${employee.id}" class="nav-link">
                            <i class="fa fa-circle-o nav-icon"></i>
                            <p>查看调度单</p>
                        </a>
                    </li>
...
<script src="${pageContext.request.contextPath}/static/bootstrap-datetimepicker.min.js"></script>
<script>
    $("#date").datetimepicker();
    ...
    $(function () {
        //获得有需要调度订单的位置
        $.ajax({
            url: "${pageContext.request.contextPath}/dispatch/getallpointsneeddispatch",
    ...
    function getModal(pid) {
        $.ajax({
            url: "${pageContext.request.contextPath}/truck/gettruckbypid",
            data: "id=" + pid,
            success: function (result) {
                $("#truckId").empty();
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/driver/getdriverbypid",
            data: "id=" + pid,
            success: function (result) {
                $("#deliverId").empty();
        ...
        var type;
        if (points[pid].type == '1') {
            type = "超市";
        } else if (points[pid].type == '2') {
            type = '仓库';
        } else if (points[pid].type = '3') {
            type = '工厂';
        }
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/merchandise/getmerchandisebypid",
            data: "id=" + pid,
            success: function (result) {
    ...
    $('#dispatch_save_btn').click(function () {
        $.ajax({
            url: "${pageContext.request.contextPath}/dispatch/savedispatch",
            method: 'post',
